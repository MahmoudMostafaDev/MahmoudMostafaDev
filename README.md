  ...
  <table>
    <tr>
      ...
      <td>
        ...
        <p style="width: 50%;">A Full-stack web application , Dedicated to displaying the latest news from different sources and places according to the user’s interest and preferences  </p>
      </td>
    </tr>
  </table>
</div>
